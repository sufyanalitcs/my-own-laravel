    ...
    <div class="container h-100">
        <div class="row h-100">
            ...
            <div class="col-2 d-flex  justify-content-center">
                <div class="">
                    <div class="footer-title">MOA Biz</div>
                    <div class="footer-links">
                        <div class="footer-link"> <a href="#">Solutions</a> </div>
                        <div class="footer-link"> <a href="#">Categories</a> </div>
                        <div class="footer-link"> <a href="#">Pricing</a> </div>
