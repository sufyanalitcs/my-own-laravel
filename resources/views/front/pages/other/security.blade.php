...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('public/front/css/other/security.css') }}">
@endsection
            ...
            <div class="row">
                <div class="col-4 dashboard-left">
                    <div class="dashboard-list">
                        <a class="dashboard-list-item " href="{{ route('about-us') }}">About Us</a>
                        ...
                        <a class="dashboard-list-item active" href="{{ route('security') }}">Security</a>
                    </div>
                </div>
...
@section('js')
    <script src="{{ asset('public/front/js/other/security.js') }}"></script>
@endsection
