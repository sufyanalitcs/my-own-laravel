...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('public/front/css/other/terms.css') }}">
@endsection
            ...
            <div class="row">
                <div class="col-4 dashboard-left">
                    <div class="dashboard-list">
                        ...
                        <a class="dashboard-list-item active" href="#"> Terms of Service </a>
...
@section('js')
    <script src="{{ asset('public/front/js/other/terms.js') }}"></script>
@endsection
