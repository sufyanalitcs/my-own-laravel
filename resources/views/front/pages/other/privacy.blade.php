...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('front/css/other/about_us.css') }}">
@endsection
            ...
            <div class="row">
                <div class="col-4 dashboard-left">
                    <div class="dashboard-list">
                        ...
                        <a class="dashboard-list-item active" href=""> Privacy Policy </a>
...
@section('js')
    <script src="{{ asset('front/js/other/about_us.js') }}"></script>
@endsection
